...
[!badge variant="dark" target="blank" size="2xl" icon="/static/pfp/meme.png" text="**Memenami**"] [!badge variant="dark" target="blank" size="2xl" icon="/static/pfp/static.png" text="**Static**"](https://github.com/whitenoisy) [!badge variant="dark" target="blank" size="2xl" icon="/static/pfp/ven.png" text="**Venlicht**"](https://github.com/RenaraScope){target="_blank"} [!badge variant="dark" target="blank" size="2xl" icon="/static/pfp/zinc.png" text="**Zinklog**"](https://github.com/zinklog2){target="_blank"}
