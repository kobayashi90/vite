...
<template>
  <div tw="w-full h-full bg-white flex flex-col" style="
      background: linear-gradient(0deg, rgba(255, 255, 255, 0.92), rgba(231, 230, 255, 0.86)),
        url(https://wvite.pages.dev/asset/gradient.png);
    ">
