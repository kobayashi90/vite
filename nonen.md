...
- [Meownime](https://m.meownime.ai/) [!badge variant="ghost" size="xs" text="DDL"]
...
- [Tunime](https://an0ncer.github.io/) [!button target="blank" variant="primary" size="xs" icon="mark-github" text="Github"](https://github.com/AN0NCER/an0ncer.github.io){target="_blank"} [!badge variant="ghost" size="xs" text="Sub"]
...
- [EroGamescape](https://erogamescape.org/) [!badge variant="dark" target="blank" text="EN Guide"](https://www.youtube.com/watch?v=oPIWgXDllzQ){target="_blank"} [!badge variant="ghost" icon="/static/icon/jp.png" text="JP"] [!badge variant="ghost" size="xs" text="Tracker"]
...
- Saikou [!badge variant="ghost" icon="/static/icon/id.png" text="ID"](https://github.com/saikou-app/saikou-in/) [!badge variant="ghost" icon="/static/icon/italy.png" text="IT"](https://github.com/antonydp/saikou-italiano){target="_blank"} [!badge variant="ghost" icon="/static/icon/spain.png" text="ES"](https://github.com/Diegopyl1209/saikouSP){target="_blank"} [!badge variant="ghost" icon="/static/icon/vietnam.png" text="VN"](https://github.com/hoangvu12/SaikouVN){target="_blank"}
...
#### Website
- [ANIFOX](https://anifox.club/anime) [!button target="blank" variant="primary" size="xs" icon="mark-github" text="Github"](https://github.com/YockyMai/ANIFOX){target="_blank"} [!badge variant="ghost" icon="/static/icon/russia.png" size="xs" text="RU"]
